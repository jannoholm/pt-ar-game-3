...
red1 = instance_create_layer(170, 350, "car", obj_car_with_physics);
with (red1) {
...
red2 = instance_create_layer(170, 730, "car", obj_car_with_physics);
with (red2) {
...
blue1 = instance_create_layer(1750, 350, "car", obj_car_with_physics);
with (blue1) {
...
blue2 = instance_create_layer(1750, 730, "car", obj_car_with_physics);
with (blue2) {
